...
export function DeclarationFormV2({
  ...
  const importDutyCompletion = countCompletedFields(formValues.import_duty, [
    'rate',
    'rate_type',
    'amount',
    'exemption_amount',
  ...
  const taxSummaryCompletion = countCompletedFields(formValues.tax_summary, [
            ...
            <CardContent className="space-y-4">
                ...
                <div>
                  <div className="flex items-center">
                    ...
                    <FieldFlagButton
                      ...
                      originalValue={
                        extractedData?.declaration_header?.declaration_type_code
                      }
                      correctedValue={
                  ...
                  <ConfidenceInput
                    ...
                    value={formValues.declaration_header?.declaration_type_code}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <ConfidenceInput
                    {...register('declaration_header.processing_division_code')}
                    value={
                      formValues.declaration_header?.processing_division_code
                    }
                    placeholder="e.g., 00"
                ...
                <div>
                  <div className="flex items-center">
                    ...
                    <FieldFlagButton
                      ...
                      originalValue={
                        extractedData?.shipping_transport?.bill_of_lading_number
                      }
                      correctedValue={
                  ...
                  <ConfidenceInput
                    ...
                    value={formValues.shipping_transport?.bill_of_lading_number}
                ...
                <div>
                  <div className="flex items-center">
                    ...
                    <FieldFlagButton
                      ...
                      originalValue={
                        extractedData?.shipping_transport?.port_of_loading_code
                      }
                      correctedValue={
                  ...
                  <ConfidenceInput
                    ...
                    value={formValues.shipping_transport?.port_of_loading_code}
                    placeholder="UN/LOCODE"
                    confidenceScore={getFieldConfidence(
                      confidenceScores,
                ...
                <div>
                  <div className="flex items-center">
                    ...
                    <FieldFlagButton
                      ...
                      originalValue={
                        extractedData?.shipping_transport?.port_of_loading_name
                      }
                      correctedValue={
                  ...
                  <ConfidenceInput
                    ...
                    value={formValues.shipping_transport?.port_of_loading_name}
                    placeholder="Port name"
                    confidenceScore={getFieldConfidence(
                      confidenceScores,
              ...
              <div>
                <div className="flex items-center">
                  ...
                  <FieldFlagButton
                    ...
                    correctedValue={formValues.package_container?.package_marks}
                  />
                </div>
                <ConfidenceInput
                ...
                <div>
                  <div className="flex items-center">
                    ...
                    <FieldFlagButton
                      ...
                      correctedValue={formValues.certificate_of_origin?.co_date}
                    />
                  </div>
                  <ConfidenceInput
                  ...
                  >
                      ...
                      <div>
                        <div className="flex items-center">
                          ...
                          <FieldFlagButton
                            ...
                            originalValue={
                              extractedData?.products?.[index]?.quantity_unit_1
                            }
                            correctedValue={
                        ...
                        <ConfidenceInput
                          ...
                          value={formValues.products?.[index]?.quantity_unit_1}
                      ...
                      <div>
                        <div className="flex items-center">
                          ...
                          <FieldFlagButton
                            ...
                            originalValue={
                              extractedData?.products?.[index]?.quantity_unit_2
                            }
                            correctedValue={
                        ...
                        <ConfidenceInput
                          ...
                          value={formValues.products?.[index]?.quantity_unit_2}
                          placeholder="Unit"
                          confidenceScore={getFieldConfidence(
                            confidenceScores,
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        ...
                        <ConfidenceInput
                          {...register(`products.${index}.invoice_unit_price`, {
                            valueAsNumber: true,
                          })}
                          type="number"
                          step="0.01"
                      ...
                      <div>
                        ...
                        <ConfidenceInput
                          {...register(`products.${index}.invoice_line_total`, {
                            valueAsNumber: true,
                          })}
                          type="number"
                          step="0.01"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <ConfidenceInput
                          {...register(`products.${index}.taxable_value_vnd`, {
                            valueAsNumber: true,
                          })}
                          type="number"
                          step="0.01"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <ConfidenceInput
                          ...
                          value={
                            formValues.products?.[index]?.country_of_origin_code
                          }
                          placeholder="e.g., CN, US"
                          maxLength={2}
                          confidenceScore={getFieldConfidence(
                      ...
                      <div>
                        ...
                        <ConfidenceInput
                          ...
                          value={
                            formValues.products?.[index]?.country_of_origin_name
                          }
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <ConfidenceInput
                    {...register('import_duty.amount', { valueAsNumber: true })}
                    type="number"
                    step="0.01"
                ...
                <div>
                  <div className="flex items-center">
                    ...
                    <FieldFlagButton
                      ...
                      correctedValue={formValues.import_duty?.exemption_amount}
                    />
                  </div>
                  <ConfidenceInput
                ...
                <div>
                  <div className="flex items-center">
                    ...
                    <FieldFlagButton
                      ...
                      originalValue={extractedData?.tax_summary?.taxpayer_type}
