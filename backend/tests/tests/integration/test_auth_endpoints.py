...
class TestRegisterEndpoint:
    ...
    async def test_register_success(self, test_client: AsyncClient, test_organization: Organization):
...
class TestLoginEndpoint:
    ...
    async def test_login_inactive_user(self, test_client: AsyncClient, db_session: AsyncSession, test_user: User):
...
class TestGetCurrentUserEndpoint:
    ...
    async def test_get_current_user_authenticated(self, test_client: AsyncClient, test_user: User):
...
class TestProtectedEndpoints:
    ...
    async def test_protected_endpoint_with_valid_token(self, test_client: AsyncClient, test_user: User):
        ...
        response = await test_client.get("/api/v1/declarations")
